...
public class Start {
    ...
    */
    ...
    public static void main(String[] args)
    {
        ...
        WindFarm farm = new WindFarm(new EngineeringModelsStub());
        farm.addWindGenerator(WindGenerator.build(123)
                .installGearPackage(new GearPackage(GearModel.CYCLONE3, .5))
                .installGeneratorPackage(new GeneratorPackage(GeneratorModel.THUNDERBOLT7, "May 1012")));

        farm.addWindGenerator(WindGenerator.build(456)
                .installGearPackage(new GearPackage(GearModel.CYCLONE3, .54))
                .installGeneratorPackage(new GeneratorPackage(GeneratorModel.SPARKY1000, "Sept 2004")));

        System.out.println(farm.generateWindFarmReport(50));
        System.out.println(farm.findBestPerformer(45));
